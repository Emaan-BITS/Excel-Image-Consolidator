...
Code Column: Type the letter of the Excel column that contains your product IDs (e.g., A).
Image Size: Select how large you want the images to appear inside the Excel file.

#Upload your files:
Step 1: Upload the folder that contains all of your product images.
Step 2: Upload your target Excel file(s) or an entire folder of Excel files.

#Click Consolidate Files. 
A progress bar will appear to track the formatting and compression process.
Once finished, a .zip file will automatically download to your computer. This file contains your newly formatted Excel spreadsheets and the missing images report.
